...
export const newQuestion = () => async (dispatch, getState) => {
...
export const chooseAnswer = id => (dispatch, getState) => {
    ...
    //store usedIds
    window.localStorage.setItem('used-ids', [...usedIds, question.id]);
};
